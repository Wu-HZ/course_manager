...
export const getBlockedTimes = () => api.get('/teacher-blocked-times/')
export const getBlockedTime = (id) => api.get(`/teacher-blocked-times/${id}/`)
export const createBlockedTime = (data) => api.post('/teacher-blocked-times/', data)
export const updateBlockedTime = (id, data) => api.put(`/teacher-blocked-times/${id}/`, data)
export const deleteBlockedTime = (id) => api.delete(`/teacher-blocked-times/${id}/`)
